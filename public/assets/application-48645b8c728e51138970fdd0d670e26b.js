...
//to change color of balloon do the following:
    //go to session.JSON file
    //change value of color for the color you desire in HEX format
...
Game.prototype.leaveGame= function(){
    $("#inflate").hide();
    $("#leave").hide();
    $("#content").append('<br><div><a data-method="delete" href="/research_sessions/'+this.research_id+'">Continue</a></div>')
    this.submitData();
}
    ...
    var data=
      {
          ...
          "earnings": (this.cashEarned).toString(),
